...
<!-- <a name="post-{{ post.id }} " class="text-white"></a> {# may be remove this string? #} -->
<div class="container">
    <table class="table table-bordered post text-center{% if post.on_moderation %}on-moderation{% endif %}"
        id="post-{{ post.id }}">
            ...
            <tr class="post-row">
                <td class="post-info">
                    ...
                    <div class="post-controls">
                        ...
                        <a
                            href="{% url 'pybb:move_post' pk=post.id %}">{% if post.is_topic_head %}{% trans 'Move' %}{% else %}{% trans "Split" %}{% endif %}</a>
                        {% endif %}
                ...
                <td class="post-content">
                    ...
                    <br />
                    {% trans 'Attachment' %}{% trans ':' %} <a
                        href="{{ attach.get_absolute_url }}">{{ attach.name }}</a>
                    ({{ attach.size_display }})
                    {% endfor %}
                    {% endif %}
                    {% endcomment %}
                    <div class="post-related">
                        ...
                        <a href="{% url 'pybb:add_post' topic.id %}?quote_id={{ post.id }}"
                            class="quote-link">{% trans 'quote' %}</a>
                        <!--
                        ...
                        <div class="attachments">
                            ...
                            <a href="{{ attachment.file.url }}"><img src="{% static 'pybb/img/attachment.png' %}">
