...
<div id="mark-all-as-read" class="text-center">
    <a href="{% url 'pybb:topic_latest' %} "
        class="btn btn-primary btn-link text-white">{% trans 'Last updates in topics' %}</a>
    <a href="{% url 'pybb:mark_all_as_read' %}"
        class="btn btn-primary btn-link text-white">{% trans 'Mark all forums as read' %}</a>
